export const ancientHistoryMcq = [
  {
...
{
  question: "Which Veda is the oldest Veda?",
  options: [
    "Yajurveda",
    "Rigveda",
    "Samaveda",
...
{
  question: "Ashoka spread which religion after the Kalinga War?",
  options: [
    "Jainism",
    "Buddhism",
    "Hinduism",
...
{
  question: "The famous university of ancient India was:",
  options: [
    "Nalanda",
    "Delhi University",
    "Takshashila College",
...
{
  question: "Which Gupta ruler was called the Napoleon of India?",
  options: [
    "Chandragupta I",
    "Samudragupta",
    "Skandagupta",
...
{
  question: "Which river was associated with the Indus Valley Civilization?",
  options: [
    "Ganga",
    "Yamuna",
    "Indus",
...
{
  question: "The Iron Pillar is located in:",
  options: [
    "Agra",
    "Delhi",
    "Patna",
...
{
  question: "The main occupation of the Harappans was:",
  options: [
    "Hunting",
    "Fishing",
    "Agriculture",
...
{
  question: "Kanishka was a ruler of which dynasty?",
  options: [
    "Maurya",
    "Kushan",
    "Gupta",
...
{
  question: "The earliest inscriptions were written in:",
  options: [
    "Brahmi script",
    "Devanagari",
    "Persian",
...
{
  question: "Which ancient Indian scholar wrote Ashtadhyayi?",
  options: [
    "Kalidasa",
    "Panini",
    "Aryabhata",
...
{
  question: "The Battle of Hydaspes was fought between Alexander and:",
  options: [
    "Ashoka",
    "Porus",
    "Harsha",
...
{
  question: "Which Chola ruler built the Brihadeshwara Temple?",
  options: [
    "Rajaraja Chola I",
    "Ashoka",
    "Pulakeshin II",
  ...
  {
  question: "Which ancient text contains the Gayatri Mantra?",
  options: [
    "Rigveda",
    "Samaveda",
    "Mahabharata",
...
{
  question: "Which city was the capital of the Kushan Empire?",
  options: [
    "Peshawar",
    "Delhi",
    "Patliputra",
...
{
  question: "The Sanchi Stupa was built by:",
  options: [
    "Ashoka",
    "Harsha",
    "Kanishka",
...
{
  question: "Which metal was unknown to the Harappans?",
  options: [
    "Gold",
    "Silver",
    "Iron",
...
{
  question: "Which dynasty was established by Pushyamitra Shunga?",
  options: [
    "Shunga",
    "Maurya",
    "Gupta",
...
},
{
  ...
  options: [
    "Nature and mother goddess",
    "Only fire",
    "Only animals",
    "None",
  ],
  answer: "Nature and mother goddess",
},
{
  question: "Which ruler is associated with the Iron Pillar inscription?",
  options: [
    "Chandragupta II",
    "Ashoka",
    "Harsha",
...
{
  question: "Which ancient port belonged to the Harappan Civilization?",
  options: [
    "Lothal",
    "Harappa",
    "Ropar",
...
{
  question: "The famous physician of ancient India was:",
  options: [
    "Charaka",
    "Kalidasa",
    "Panini",
...
{
  question: "Which ruler adopted Buddhism after war?",
  options: [
    "Ashoka",
    "Harsha",
    "Samudragupta",
...
{
  question: "The Vedic people primarily lived in:",
  options: [
    "Villages",
    "Cities",
    "Ports",
...
{
  question: "Which Gupta ruler issued silver coins?",
  options: [
    "Chandragupta II",
    "Samudragupta",
    "Kumaragupta",
...
{
  question: "Which script was used in Ashokan inscriptions?",
  options: [
    "Brahmi",
    "Kharosthi",
    "Arabic",
...
{
  question: "Which book was written by Aryabhata?",
  options: [
    "Aryabhatiya",
    "Arthashastra",
    "Meghaduta",
...
{
  question: "Which dynasty ruled after the Mauryas?",
  options: [
    "Shunga",
    "Gupta",
    "Kushan",
...
{
  question: "The Harappans traded with:",
  options: [
    "Mesopotamia",
    "China only",
    "Rome only",
...
{
  question: "Which ruler convened the Fourth Buddhist Council?",
  options: [
    "Kanishka",
    "Ashoka",
    "Harsha",
...
{
  question: "Who was known as Vikramaditya?",
  options: [
    "Chandragupta II",
    "Ashoka",
    "Samudragupta",
...
{
  question: "Which animal is frequently seen on Harappan seals?",
  options: [
    "Bull",
    "Horse",
    "Lion",
...
{
  question: "Which ancient Indian mathematician discovered zero?",
  options: [
    "Aryabhata",
    "Panini",
    "Kalidasa",
...
{
  question: "The Buddhist text Tripitaka is written in:",
  options: [
    "Pali",
    "Sanskrit",
    "Hindi",
...
{
  question: "Which ruler defeated the Hunas?",
  options: [
    "Skandagupta",
    "Ashoka",
    "Harsha",
...
{
  question: "Which river valley gave rise to the Harappan Civilization?",
  options: [
    "Indus Valley",
    "Ganga Valley",
    "Nile Valley",
...
{
  question: "The capital of Harsha’s kingdom was:",
  options: [
    "Kannauj",
    "Delhi",
    "Pataliputra",
...
{
  question: "Which Gupta ruler was famous for his naval power?",
  options: [
    "Samudragupta",
    "Chandragupta I",
    "Ashoka",
...
{
  question: "The term ‘Mohenjo-Daro’ means:",
  options: [
    "Mound of the dead",
    "City of kings",
    "Land of rivers",
...
{
  question: "Who introduced gold coins on a large scale in India?",
  options: [
    "Kushans",
    "Mauryas",
    "Cholas",
...
{
  question: "Which Veda deals with music?",
  options: [
    "Samaveda",
    "Rigveda",
    "Yajurveda",
...
{
  question: "Which ruler founded the Pala dynasty?",
  options: [
    "Gopala",
    "Dharmapala",
    "Devapala",
...
{
  question: "Who discovered the Harappan Civilization?",
  options: [
    "Dayaram Sahni",
    "Aryabhata",
    "Banabhatta",
...
{
  question: "Which dynasty built the Sun Temple at Konark?",
  options: [
    "Eastern Ganga",
    "Maurya",
    "Gupta",
  ...
  answer: "Eastern Ganga",
},
{
  question: "The official language of Mauryan administration was:",
  options: [
    "Prakrit",
    "Hindi",
    "Tamil",
...
{
  question: "Who founded the Rashtrakuta dynasty?",
  options: [
    "Dantidurga",
    "Krishna I",
    "Amoghavarsha",
...
{
  question: "Which king built the Vikramashila University?",
  options: [
    "Dharmapala",
    "Ashoka",
    "Harsha",
...
{
  question: "Which ancient traveler visited India during Harsha’s reign?",
  options: [
    "Hiuen Tsang",
    "Megasthenes",
    "Fa-Hien",
...
{
  question: "Which dynasty is known for temple architecture at Mahabalipuram?",
  options: [
    "Pallava",
    "Maurya",
    "Gupta",
...
{
  question: "The Rigvedic Aryans worshipped:",
  options: [
    "Natural forces",
    "Idols only",
    "Kings only",
...
{
  question: "Which ruler was called Devanampriya Priyadarshi?",
  options: [
    "Ashoka",
    "Harsha",
    "Kanishka",
...
{
  question: "Which city is famous for the ruins of Nalanda University?",
  options: [
    "Bihar",
    "Delhi",
    "Ujjain",
...
{
  question: "The earliest coins in India were called:",
  options: [
    "Punch-marked coins",
    "Gold dinars",
    "Tanka",
...
{
  question: "Which Gupta ruler performed the Ashwamedha sacrifice?",
  options: [
    "Samudragupta",
    "Ashoka",
    "Kanishka",
